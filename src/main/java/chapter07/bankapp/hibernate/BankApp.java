package chapter07.bankapp.hibernate;
...
public class BankApp {
    ...
    public static void main(String[] args) throws Exception {
        ApplicationContext context = new ClassPathXmlApplicationContext(
                "classpath:META-INF/spring/chapter07/bankapp/hibernate/applicationContext.xml");
        ...
        fdd.setActive("Y");
        fdd.setBankAccountDetails(bankAccountDetails);
