                ...
                <td>
                    <table class="border" cellpadding="10">
                        <tr>
                            ...
                            <td class="td">
                                <input type="text" name="depositAmount" value="${requestScope.fixedDepositDetails.depositAmount}"/>
                                <font style="color: #C11B17;"><c:out value="${requestScope['error.depositAmount']}"/></font>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="td">
                                ...
                                <font style="color: #C11B17;"><c:out value="${requestScope['error.tenure']}"/></font>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="td">
                                ...
                                <font style="color: #C11B17;"><c:out value="${requestScope['error.email']}"/></font>
                            </td>
                        </tr>
                    </table>
                </td>
