                    ...
                    <table align="left" style="padding-left: 300px;">
                        <tr>
                            <td style="font-family: Arial; font-size: 16px; font-weight: bold;">
                                <spring:message code="fd.list.title"/>
                            </td>
                        </tr>
                        <tr><td>&nbsp;</td></tr>
                        <tr>
                                ...
                                <table class="border" cellpadding="10">
                                    ...
                                    <c:forEach items="${fdList}" var="fixedDeposit">
                                        <tr>
                                            ...
                                            <td class="td">
                                                <a href="${pageContext.request.contextPath}/fixedDeposit?fdAction=close&fixedDepositId=${fixedDeposit.id}" style="color: green"><spring:message code="fd.close.title"/></a>
                                                <a href="${pageContext.request.contextPath}/fixedDeposit?fdAction=view&fixedDepositId=${fixedDeposit.id}" style="color: green"><spring:message code="fd.edit.title"/></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </table>
        ...
        <table align="left" style="padding-left: 300px;">
            <tr>
                <td class="tdnoborder">
                    ...
                    <a href="${pageContext.request.contextPath}/fixedDeposit/list?lang=cn_CN">中文(CN)</a>
                    <%--<a href="${pageContext.request.contextPath}/fixedDeposit/list?lang=en_AU">English(Australia)</a>--%>
                    <br> <b>Locale:</b>
